...
{
    public partial class DeepHistoryTests_Fluent
    {
        [Fact]
        public void DeepHistory_Restores_LeafPath_After_Reentering_Fluent()
        {
            var m = new DeepHistoryMachine_Fluent(S.Out);
            m.Start();
        ...
        public partial class DeepHistoryMachine_Fluent
        {

...
namespace FastFsm.Tests.Features.Hsm.Runtime
{
    ...
    public partial class InitialChildTestsLegacy
    {
        ...
        {
            var m = new InitialChildMachineLegacy(S.Outside);
            m.Start();
    ...
    public partial class ShallowHistoryTestsLegacy
    {
        ...
        {
            var m = new ShallowHistoryMachineLegacy(S.Outside);
            m.Start();
    ...
    public partial class DeepHistoryTestsLegacy
    {
        ...
        {
            var type = typeof(DeepHistoryMachineLegacy);

            // instancja jest potrzebna, jeśli będziemy czytać chronione właściwości
            var instance = Activator.CreateInstance(type, DeepHistoryTestsLegacy.S.Out)!;
        ...
        {
            var m = new DeepHistoryMachineLegacy(S.Out);
            m.Start();
    ...
    public partial class InternalTransitionTestsLegacy
    {
        ...
        {
            var m = new InternalMachineLegacy(S.Parent);
        ...
        {
            var m = new InternalMachineLegacy(S.Parent) { UseChildInternal = true };
            m.Start();
            m.Log.Clear();
    ...
    public partial class ResolutionOrderTestsLegacy
    {
        [Fact]
        public void HigherPriority_Wins_Even_If_Parent()
        {
            var m = new PriorityMachineLegacy(S.Parent);
        ...
        {
            var m = new ChildOverridesMachineLegacy(S.Parent);
            m.Start();
            m.Fire(T.Go);
        ...
        {
            var m = new SourceOrderTieMachineLegacy(S.A);
            m.Start();
            m.Fire(T.Go);
        ...
        [Abstractions.Attributes.StateMachine(typeof(S), typeof(T), EnableHierarchy = true)]
        public partial class PriorityMachineLegacy
        {
            public List<string> Log { get; } = new();
        ...
        [Abstractions.Attributes.StateMachine(typeof(S), typeof(T), EnableHierarchy = true)]
        public partial class ChildOverridesMachineLegacy
        {
            public List<string> Log { get; } = new();
        ...
        public partial class SourceOrderTieMachineLegacy
        {
            public List<string> Log { get; } = new();
    ...
    public partial  class InheritanceAndIntrospectionTests
    {
        ...
        {
            var m = new InheritanceMachineLegacy(S.Outside);
            m.Start();
        ...
        [Abstractions.Attributes.StateMachine(typeof(S), typeof(T), EnableHierarchy = true)]
        public partial class InheritanceMachineLegacy
        {
            [State(S.Parent)] private void Parent() { }

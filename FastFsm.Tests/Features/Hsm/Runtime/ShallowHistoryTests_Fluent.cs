...
{
    public partial class ShallowHistoryTests_Fluent
    {
        [Fact]
        public void Reentering_Parent_With_ShallowHistory_Restores_LastChild_Fluent()
        {
            var m = new ShallowHistoryMachine_Fluent(S.Outside);
            m.Start();

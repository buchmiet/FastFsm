...
{
    public partial class InitialChildTests_Fluent
    {
        [Fact]
        public void Transition_ToCompositeParent_Enters_ItsInitialChild_Fluent()
        {
            var m = new InitialChildMachine_Fluent(S.Outside);
            m.Start();

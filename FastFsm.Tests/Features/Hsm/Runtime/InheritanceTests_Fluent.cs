...
{
    public partial class InheritanceTests_Fluent
    {
        [Fact]
        public void Child_Inherits_Parent_Transitions_And_PermittedTriggers_Unions_Fluent()
        {
            var m = new InheritanceMachine_Fluent(S.Outside);
            m.Start();
        ...
        [Fact]
        public void IsInHierarchy_Reports_Correctly_Fluent()
        {
            var m = new InheritanceMachine_Fluent(S.Outside);
            m.Start();
        ...
        public partial class InheritanceMachine_Fluent
        {

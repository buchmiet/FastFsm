...
namespace FastFsm.Tests.Features.Hsm.CompileTime
{
    ...
    /// </summary>
    public partial class HsmAdditionalCompilationTestsLegacy
    {
        // =========================
        ...
        public partial class HsmPayloadMachineLegacy
        {
        ...
        {
            var m = new HsmPayloadMachineLegacy(HP_State.Root);
            Assert.NotNull(m);
        ...
        public partial class EqualPriorityMachineLegacy
        {
        ...
        {
            var m = new EqualPriorityMachineLegacy(EP_State.A);
            Assert.NotNull(m);
        }
        ...
        public partial class HierarchyFlagNoHierarchyMachineLegacy
        {
        ...
        {
            var m = new HierarchyFlagNoHierarchyMachineLegacy(NH_State.S1);
            Assert.NotNull(m);
        }
    }
}

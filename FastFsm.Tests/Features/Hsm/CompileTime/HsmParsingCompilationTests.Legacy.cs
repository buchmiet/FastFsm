...
/// </summary>
public partial class HsmParsingCompilationTestsLegacy
{
    #region Test Enums
    // Enums moved to HsmParsingCompilationTests.Fluent.cs to avoid duplication
    /*
    ...
    */
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class DeepHierarchyMachineLegacy
    {
        // Level 1
        [State(HsmState.Working)]
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class PriorityTransitionMachineLegacy
    {
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class CrossHierarchyMachineLegacy
    {
        // Branch 1
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class ComplexMixedScenarioMachineLegacy
    {
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class InitialStateMachineLegacy
    {
    ...
    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class EdgeCaseMachineLegacy
    {
    ...
    {
        var machine = new SimpleParentChildMachineLegacy(HsmState.Idle);
    ...
    {
        var machine = new DeepHierarchyMachineLegacy(HsmState.Working);
        Assert.NotNull(machine);
    ...
    {
        var machine = new ShallowHistoryMachineLegacy(HsmState.HistoryParent);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new DeepHistoryMachineLegacy(HsmState.DeepHistoryParent);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new PriorityTransitionMachineLegacy(HsmState.Priority_Low);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new InternalTransitionMachineLegacy(HsmState.InternalParent);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new CrossHierarchyMachineLegacy(HsmState.Branch1);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new ComplexMixedScenarioMachineLegacy(HsmState.ComplexParent);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new InitialStateMachineLegacy(HsmState.Working);
        Assert.NotNull(machine);
    }
    ...
    {
        var machine = new EdgeCaseMachineLegacy(HsmState.EdgeParent);
        Assert.NotNull(machine);
    }
    ...
    [Fact]
    public void DeepHierarchyMachineFluentCanBeInstantiated()
    {
        var machine = new DeepHierarchyMachineFluent(HsmState.Working);
        Assert.NotNull(machine);
    }

    [Fact]
    public void PriorityTransitionMachineFluentCanBeInstantiated()
    {
        var machine = new PriorityTransitionMachineFluent(HsmState.Priority_Low);
        Assert.NotNull(machine);
    }

    [Fact]
    public void CrossHierarchyMachineFluentCanBeInstantiated()
    {
        var machine = new CrossHierarchyMachineFluent(HsmState.Branch1);
        Assert.NotNull(machine);
    }

    [Fact]
    public void ComplexMixedScenarioMachineFluentCanBeInstantiated()
    {
        var machine = new ComplexMixedScenarioMachineFluent(HsmState.ComplexParent);
        Assert.NotNull(machine);
    }

    [Fact]
    public void EdgeCaseMachineFluentCanBeInstantiated()
    {
        var machine = new EdgeCaseMachineFluent(HsmState.EdgeParent);
        Assert.NotNull(machine);
    }

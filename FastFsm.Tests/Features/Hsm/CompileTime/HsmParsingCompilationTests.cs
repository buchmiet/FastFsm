...
public partial class HsmParsingCompilationTests
{
    ...
    [Fact]
    public void DeepHierarchyMachine_FluentCanBeInstantiated()
    {
        var machine = new DeepHierarchyMachine_Fluent(HsmState.Working);
        Assert.NotNull(machine);
    }

    [Fact]
    public void PriorityTransitionMachine_FluentCanBeInstantiated()
    {
        var machine = new PriorityTransitionMachine_Fluent(HsmState.Priority_Low);
        Assert.NotNull(machine);
    }

    [Fact]
    public void CrossHierarchyMachine_FluentCanBeInstantiated()
    {
        var machine = new CrossHierarchyMachine_Fluent(HsmState.Branch1);
        Assert.NotNull(machine);
    }

    [Fact]
    public void ComplexMixedScenarioMachine_FluentCanBeInstantiated()
    {
        var machine = new ComplexMixedScenarioMachine_Fluent(HsmState.ComplexParent);
        Assert.NotNull(machine);
    }

    [Fact]
    public void EdgeCaseMachine_FluentCanBeInstantiated()
    {
        var machine = new EdgeCaseMachine_Fluent(HsmState.EdgeParent);
        Assert.NotNull(machine);
    }
    ...
    #region 1. DeepHierarchyMachine_Fluent
    ...
    #region 2. PriorityTransitionMachine_Fluent
    ...
    #region 3. CrossHierarchyMachine_Fluent

    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class CrossHierarchyMachine_Fluent
    {
        private void SetupStates()
        {
            // Branch 1
    ...
    #region 4. ComplexMixedScenarioMachine_Fluent

    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class ComplexMixedScenarioMachine_Fluent
    {
        private void SetupStates()
        {
            // Parent with history
    ...
    #region 5. EdgeCaseMachine_Fluent

    [StateMachine(typeof(HsmState), typeof(HsmTrigger), EnableHierarchy = true)]
    public partial class EdgeCaseMachine_Fluent
    {
        private void SetupStates()
        {

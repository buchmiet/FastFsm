...
public class StateCallbackTestsLegacy(ITestOutputHelper output)
{
    ...
    [Fact]
    public void Legacy_MultipleOnEntryOnExit_ForSameState_NotSupported()
    {
        ...
        var machine = new Machines.MultipleCallbacksMachineLegacy(StateCallbackTests.MultiState.A);
        machine.Start();
        var typedMachine = machine;

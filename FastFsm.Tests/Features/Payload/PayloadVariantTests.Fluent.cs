...
public class PayloadVariantTestsFluent(ITestOutputHelper output)
{
    [Fact]
    public void SinglePayloadType_BasicTransition_PassesPayloadCorrectly()
    {
        // Arrange
        var machine = new OrderStateMachineFluent(OrderState.New);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new PaymentMachineFluent(PaymentState.Pending);
        machine.Start();
        ...
        // Reset
        machine = new PaymentMachineFluent(PaymentState.Pending);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new NotificationMachineFluent(NotificationState.Ready);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ProcessingMachineFluent(ProcessingState.Idle);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MultiPayloadMachineFluent(MultiState.Initial);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MultiPayloadMachineFluent(MultiState.Configured);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new OverloadedMachineFluent(OverloadState.A);
        machine.Start();
        ...
        machine = new OverloadedMachineFluent(OverloadState.A);
        machine.Start();
        machine.CallLog.Clear();
    ...
    {
        // Arrange
        var machine = new InternalPayloadMachineFluent(InternalPayloadState.Active);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MixedPayloadMachineFluent(MixedState.Start);
        machine.Start();
    ...
    {
        // Arrange & Act
        var machine = new InitialPayloadMachineFluent(InitialPayloadState.Start);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ExitCallbackMachineFluent(ExitState.A);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new WorkflowMachineFluent(WorkflowState.Created);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ConditionalPayloadMachineFluent(ConditionalState.Ready);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new PermittedTriggersMachineFluent(PermittedState.A);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new StrictMultiPayloadMachineFluent(StrictState.Ready);
        machine.Start();

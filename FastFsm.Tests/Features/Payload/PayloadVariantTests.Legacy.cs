...
public class PayloadVariantTestsLegacy(ITestOutputHelper output)
{
    [Fact]
    public void SinglePayloadType_BasicTransition_PassesPayloadCorrectly()
    {
        // Arrange
        var machine = new OrderStateMachineLegacy(OrderState.New);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new PaymentMachineLegacy(PaymentState.Pending);
        machine.Start();
        ...
        // Reset
        machine = new PaymentMachineLegacy(PaymentState.Pending);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new NotificationMachineLegacy(NotificationState.Ready);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ProcessingMachineLegacy(ProcessingState.Idle);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MultiPayloadMachineLegacy(MultiState.Initial);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MultiPayloadMachineLegacy(MultiState.Configured);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new OverloadedMachineLegacy(OverloadState.A);
        machine.Start();
        ...
        machine = new OverloadedMachineLegacy(OverloadState.A);
        machine.Start();
        machine.CallLog.Clear();
    ...
    {
        // Arrange
        var machine = new InternalPayloadMachineLegacy(InternalPayloadState.Active);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new MixedPayloadMachineLegacy(MixedState.Start);
        machine.Start();
    ...
    {
        // Arrange & Act
        var machine = new InitialPayloadMachineLegacy(InitialPayloadState.Start);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ExitCallbackMachineLegacy(ExitState.A);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new WorkflowMachineLegacy(WorkflowState.Created);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new ConditionalPayloadMachineLegacy(ConditionalState.Ready);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new PermittedTriggersMachineLegacy(PermittedState.A);
        machine.Start();
    ...
    {
        // Arrange
        var machine = new StrictMultiPayloadMachineLegacy(StrictState.Ready);
        machine.Start();
    ...
    public void SinglePayloadType_WithoutPayload_TransitionsButNoAction()
    {
        ...
        Assert.True(result);
        Assert.Equal(OrderState.Submitted, machine.CurrentState);
        // Action didn't execute because no payload was provided

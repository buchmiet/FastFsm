...
{
    /// <summary>
    /// Zestaw testów weryfikujących poprawną obsługę wyjątków w rozszerzeniach - wersja Fluent API.
    /// </summary>
    public class ExceptionHandlingTests_Fluent
    {
        /// <summary>
        ...
        public void Extension_Exception_DoesNot_Break_Transition()
        {
            ...
            var machine = new TestMachine_Fluent(State.Initial, [throwing, counting]);
            machine.Start();

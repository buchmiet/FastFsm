...
public class ExceptionDirective_Propagate_Action_TestsLegacy
{
    [Fact]
    public void ActionThrow_Propagate_Throws_StateChanged()
    {
        var m = new PropagateOnActionMachineLegacy(PSState.A);
        m.Start();
...
public partial class PropagateOnActionMachineLegacy
{

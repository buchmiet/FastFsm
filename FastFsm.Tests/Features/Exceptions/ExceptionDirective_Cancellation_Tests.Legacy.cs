...
public class ExceptionDirective_Cancellation_TestsLegacy
{
    [Fact]
    public async Task OnEntry_OCE_AlwaysPropagates_EvenIfHandlerReturnsContinue()
    {
        var m = new AsyncOceOnEntryMachineLegacy(CSState.A) { ThrowOceOnEntryB = true };
        await m.StartAsync();
...
public partial class AsyncOceOnEntryMachineLegacy
{

...
public class BenchmarkTestsLegacy(ITestOutputHelper output)
{
    [Fact]
    public void Legacy_Core_MillionTransitions_PerformanceTest()
    {
        // Arrange
        ...
        output.WriteLine($"Legacy Core (baseline) Performance:");
    ...
    [Fact]
    public void Legacy_CoreWithCallbacks_MillionTransitions_PerformanceTest()
    {
        // Arrange
        ...
        output.WriteLine($"Legacy Core+Callbacks Performance (with OnEntry/OnExit):");
        output.WriteLine($"  Total time: {sw.ElapsedMilliseconds}ms");
        output.WriteLine($"  Per transition: {nsPerTransition:F1}ns");
        output.WriteLine($"  Throughput: {transitionsPerSecond:N0} transitions/sec");
    ...
    [Fact]
    public void Legacy_CompareCoreVsCoreWithCallbacks_PerformanceOverhead()
    {
        ...
        output.WriteLine($"Legacy Feature Comparison ({iterations:N0} transitions):");
    ...
    [Fact]
    public void Legacy_GuardEvaluation_PerformanceImpact_Improved()
    {
        ...
        output.WriteLine($"Legacy Guard Impact ({iterations:N0} transitions, median of 5 runs):");
    ...
    [Fact]
    public void Legacy_GuardEvaluation_RealWorldPerformance()
    {
        ...
        output.WriteLine($"Legacy Real-world simulation:");

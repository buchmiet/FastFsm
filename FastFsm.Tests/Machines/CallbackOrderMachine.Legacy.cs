...
public partial class CallbackOrderMachineLegacy
{
    ...
    [Transition(CallbackState.A, CallbackTrigger.Next, CallbackState.B, Action = nameof(ActionAtoB))]
    [Transition(CallbackState.B, CallbackTrigger.Next, CallbackState.C, Action = nameof(ActionBtoC))]

...
public class AsyncPayloadStateMachineTests
{
    ...
    {
        // Arrange
        var machine = new BasicAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Initial);
    ...
    {
        // Arrange
        var machine = new OverloadedAsyncMachineFluentFsm(AsyncPayloadStates.Initial);
        await machine.StartAsync();
        ...
        machine = new OverloadedAsyncMachineFluentFsm(AsyncPayloadStates.Initial);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new MultiPayloadAsyncMachineFluentFsm(MultiPayloadStates.Ready);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new ExceptionAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Initial);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new CanFireAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Initial, threshold: 100);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new ConcurrentAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Processing);
        await machine.StartAsync();
    ...
    {
        // Arrange & Act
        var machine = new InitialOnEntryAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Initial);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new BasicAsyncPayloadMachineFluentFsm(AsyncPayloadStates.Completed);
        await machine.StartAsync();

...
public class CancellationTokenCoreTests
{
    ...
    {
        // Arrange
        var machine = new BasicTokenMachineFluentFsm(TokenTestState.Initial);
    ...
    {
        // Arrange
        var machine = new OptionalTokenMachineFluentFsm(TokenTestState.Initial);
        await machine.StartAsync();
        using var cts = new CancellationTokenSource();
    ...
    {
        // Arrange
        var machine = new CancellationMachineFluentFsm(TokenTestState.Initial);
        await machine.StartAsync();
        using var cts = new CancellationTokenSource();
    ...
    {
        // Arrange
        var machine = new MixedTokenMachineFluentFsm(TokenTestState.Initial);
        await machine.StartAsync();
    ...
    {
        // Arrange & Act
        var machine = new BasicTokenMachineFluentFsm(TokenTestState.Processing);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new CancellationMachineFluentFsm(TokenTestState.Processing);

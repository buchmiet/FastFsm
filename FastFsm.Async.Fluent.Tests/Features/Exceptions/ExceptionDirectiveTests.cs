...
public class ExceptionDirectiveTests
{
    ...
    {
        // Arrange
        var machine = new OnEntryContinueMachineFluentFsm(ExceptionTestStates.Idle);
    ...
    {
        // Arrange
        var machine = new ActionPropagateMachineFluentFsm(ExceptionTestStates.Idle);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new GuardExceptionMachineFluentFsm(ExceptionTestStates.Idle);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new CancellationPropagationMachineFluentFsm(ExceptionTestStates.Idle);
        await machine.StartAsync();
    ...
    {
        // Arrange
        var machine = new AsyncHandlerMachineFluentFsm(ExceptionTestStates.Idle);
        await machine.StartAsync();
        using var cts = new CancellationTokenSource();
    ...
    public async Task Exception_Context_Should_Have_Correct_Values()
    {
        ...
        var machine = new ExceptionContextCaptureMachineFluentFsm(

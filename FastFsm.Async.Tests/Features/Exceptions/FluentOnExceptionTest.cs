...
public class FluentPropagateTests
{
    ...
    public async Task FluentApi_OnException_PropagatesException()
    {
        ...
        // For action exceptions, state change occurs before action.
        // With Propagate directive, exception is rethrown and the new state remains.
        machine.CurrentState.ShouldBe(TestState.Working, "State changes before action; remains on Propagate");
    }
}

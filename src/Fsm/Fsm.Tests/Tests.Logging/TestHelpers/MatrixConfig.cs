    ...
    public static class MatrixConfig
    {
        ...
        public static readonly IReadOnlyDictionary<string, MachineTestConfig> Machines =
            new Dictionary<string, MachineTestConfig>(StringComparer.Ordinal)
            {
                ...
                ["PayloadStateMachine"] = new MachineTestConfig { MachineName = "PayloadStateMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Logging.TestPayload() } },
                ...
                ["FullStateMachine"] = new MachineTestConfig { MachineName = "FullStateMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Logging.TestPayload() } },
                ["MultiPayloadStateMachine"] = new MachineTestConfig { MachineName = "MultiPayloadStateMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Logging.TestPayload() } },
                ...
                ["FullMultiPayloadMachine"] = new MachineTestConfig { MachineName = "FullMultiPayloadMachine", InitialState = "New", TriggerSequence = new[] { "Process" }, Payloads = new object?[] { new Tests.Logging.OrderPayload { OrderId = 1001, Amount = 100.50m } } },

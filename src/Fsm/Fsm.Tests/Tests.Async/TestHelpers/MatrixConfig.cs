        ...
        public static readonly IReadOnlyDictionary<string, MachineTestConfig> Machines =
            new Dictionary<string, MachineTestConfig>(StringComparer.Ordinal)
            {
                ...
                ["BasicPayload"] = new MachineTestConfig
                {
                    ...
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 1, Data = "P" } }
                },
                ["OverloadedPayload"] = new MachineTestConfig
                {
                    ...
                    InitialState = "Initial",
                    TriggerSequence = new[] { "Start" },
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 2, Data = "P" } }
                },
                ["ExceptionPayload"] = new MachineTestConfig
                {
                    ...
                    InitialState = "Initial",
                    TriggerSequence = new[] { "Start" },
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 3, Data = "P" } }
                },
                ["CanFirePayload"] = new MachineTestConfig
                {
                    ...
                    InitialState = "Initial",
                    TriggerSequence = new[] { "Start" },
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 10, Data = "P" } }
                },
                ["ConcurrentPayload"] = new MachineTestConfig
                {
                    ...
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 100, Data = "P" } }
                },
                ["InitialOnEntryPayload"] = new MachineTestConfig
                {
                    ...
                    InitialState = "Initial",
                    TriggerSequence = new[] { "Start" },
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 5, Data = "P" } }
                },
                ["MultiPayload"] = new MachineTestConfig
                {
                    ...
                    Payloads = new object?[] { new Tests.Async.Features.Payload.ConfigPayload { Setting = "S", Timeout = 1 } }
                },
                ...
                ["BasicAsyncPayloadMachine"] = new MachineTestConfig { MachineName = "BasicAsyncPayloadMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 1, Data = "P" } } },
                ["OverloadedAsyncMachine"] = new MachineTestConfig { MachineName = "OverloadedAsyncMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 2, Data = "P" } } },
                ["ExceptionAsyncPayloadMachine"] = new MachineTestConfig { MachineName = "ExceptionAsyncPayloadMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 3, Data = "P" } } },
                ["CanFireAsyncPayloadMachine"] = new MachineTestConfig { MachineName = "CanFireAsyncPayloadMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 10, Data = "P" } } },
                ["ConcurrentAsyncPayloadMachine"] = new MachineTestConfig { MachineName = "ConcurrentAsyncPayloadMachine", InitialState = "Processing", TriggerSequence = new[] { "Process" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 100, Data = "P" } } },
                ["InitialOnEntryAsyncPayloadMachine"] = new MachineTestConfig { MachineName = "InitialOnEntryAsyncPayloadMachine", InitialState = "Initial", TriggerSequence = new[] { "Start" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ProcessPayload { Id = 5, Data = "P" } } },
                ["MultiPayloadAsyncMachine"] = new MachineTestConfig { MachineName = "MultiPayloadAsyncMachine", InitialState = "Ready", TriggerSequence = new[] { "Configure" }, Payloads = new object?[] { new Tests.Async.Features.Payload.ConfigPayload { Setting = "S", Timeout = 1 } } },
                ...
                ["PayloadMachine"] = new MachineTestConfig { MachineName = "PayloadMachine", InitialState = "Off", TriggerSequence = new[] { "ToggleOn" }, Payloads = new object?[] { new Tests.Async.Features.Cancellation.TogglePayload { Id = 7 } } },

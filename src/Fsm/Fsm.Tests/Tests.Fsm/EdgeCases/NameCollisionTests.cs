...
namespace Tests.Fsm.EdgeCases
{
    public class NameCollisionTests
    {
        ...
        {
            // Arrange & Act
            var machine = new KeywordStateMachine(KeywordState.@class);
            machine.Start();
        ...
        public void ReservedMethodNames_DontConflictWithGenerated()
        {
            ...
            var machine = new ConflictingNamesMachine(ConflictState.A);
            machine.Start();
            var typedMachine = machine as ConflictingNamesMachine;
        ...
        public void SpecialCharactersInEnumNames_HandledCorrectly()
        {
            ...
            var machine = new UnicodeMachine(UnicodeState.αlpha);
            machine.Start();
        ...
        public void VeryLongStateNames_HandledCorrectly()
        {
            ...
            var machine = new LongNameMachine(
        ...
        public void NumericPrefixedNames_HandledCorrectly()
        {
            ...
            var machine = new NumericMachine(NumericState._1Start);
            machine.Start();
        ...
        public void CaseSensitiveNames_HandledCorrectly()
        {
            ...
            var machine = new CaseSensitiveMachine(CaseSensitiveState.state);
            machine.Start();

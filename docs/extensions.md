...
- `src/Fsm/Fsm.Tests/Tests.Machines/Extensions/` — extension implementations used by tests
- `src/Fsm/Fsm.Tests/Tests.Fsm/Features/Extensions/OnTransitionedTests.*` — `OnTransitioned` ordering tests

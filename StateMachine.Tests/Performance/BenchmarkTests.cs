...
namespace StateMachine.Tests.Performance
{
    public class BenchmarkTests(ITestOutputHelper output)
    {
        [Fact]
        public void PureVariant_MillionTransitions_PerformanceTest()
        {
            // Arrange
            ...
            output.WriteLine($"Pure Variant Performance:");
        ...
        [Fact]
        public void BasicVariant_MillionTransitions_PerformanceTest()
        {
            // Arrange
            ...
            output.WriteLine($"Basic Variant Performance (with OnEntry/OnExit):");
            output.WriteLine($"  Total time: {sw.ElapsedMilliseconds}ms");
            output.WriteLine($"  Per transition: {nsPerTransition:F1}ns");
            output.WriteLine($"  Throughput: {transitionsPerSecond:N0} transitions/sec");
        ...
        [Fact]
        public void CompareVariants_PerformanceOverhead()
        {
            ...
            output.WriteLine($"Variant Comparison ({iterations:N0} transitions):");
            output.WriteLine($"  Pure:  {pureTime:F2}ms");
            output.WriteLine($"  Basic: {basicTime:F2}ms");

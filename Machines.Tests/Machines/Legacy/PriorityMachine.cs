...
public partial class PriorityMachine
{
    ...
    [Transition(PriorityMachine_S.Parent, PriorityMachine_T.Go, PriorityMachine_S.ParentDone, Priority = 200, Action = (P))]
    [Transition(PriorityMachine_S.Child, PriorityMachine_T.Go, PriorityMachine_S.Child, Priority = 100, Action = (C))]

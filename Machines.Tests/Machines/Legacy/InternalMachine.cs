...
public partial class InternalMachine
{
    ...
    [State(InternalMachine_S.Parent, OnEntry = (OnParentEntry))] private void Parent() { }
    [State(InternalMachine_S.Child, Parent = InternalMachine_S.Parent, IsInitial = true,
        OnEntry = (OnChildEntry), OnExit = (OnChildExit))]
    private void Child() { }

    // Parent internal (always present)
    [InternalTransition(InternalMachine_S.Parent, InternalMachine_T.Refresh, Action = (ParentInternalAction))]
    ...
    [InternalTransition(InternalMachine_S.Child, InternalMachine_T.Refresh, Guard = (UseChildInternalGuard), Action = (ChildInternalAction))]
